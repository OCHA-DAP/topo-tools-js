...
instead of `CLAUDE.md` or a `docs/explanation/*.md` file if it would
otherwise be a paragraph starting with "confirmed", "previously", "was
misdiagnosed", or "empirically tested" — narrative investigation history,
not current-state description.
